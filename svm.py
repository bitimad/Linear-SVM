...
class svm(object):
    ...
    def visualize(self):
        ...
        pav1 = self.hyperplane(hyp_x_min, self.w, self.b, 1)
        pav2 = self.hyperplane(hyp_x_max, self.w, self.b, 1)
        self.ax.plot([hyp_x_min, hyp_x_max], [pav1, pav2], 'k')

        nav1 = self.hyperplane(hyp_x_min, self.w, self.b, -1)
        nav2 = self.hyperplane(hyp_x_max, self.w, self.b, -1)
